   ...
   <div class="row demo-row">
                ...
                <div class="form-group">
                  <div class="input-group">
                    ...
                    <span class="input-group-btn">
                      <button type="submit" class="btn" onclick="submitForm('/account/underconstruction.action', 'NO-DATA', 'containerdiv');"><span class="fui-search"></span></button>
                    </span>
                  </div>
                </div>
              </form>
      ...
      <div class="row demo-samples">
            ...
            <ul>
              <li class="todo-done">
                ...
                <div class="todo-content">
                  <h4 class="todo-name">
                  	<a href="#" onclick="submitForm('/account/patiantentry.action', 'NO-DATA', 'containerdiv');"><strong>Patiant Entry</strong></a>
                  </h4>
              ...
              <li>
                ...
                <div class="todo-content">
                  <h4 class="todo-name">
                    <a href="#" onclick="submitForm('/account/formf.action', 'NO-DATA', 'containerdiv');"><strong>Form F</strong></a>
                  </h4>
                  Can search form F
                </div>
              </li>
              <li>
                ...
                <div class="todo-content">
                  <h4 class="todo-name">
                    <a href="#" onclick="submitForm('/account/formfreport.action', 'NO-DATA', 'containerdiv');"><strong>Form F - View</strong></a>
                  </h4>Restricted by the role
                </div>
              </li>
              <li>
        ...
        <div class="col-xs-8, col-lg-8 col-md-8">
	        <div id="containerdiv">
	            <div class="login-form">&nbsp;&nbsp; Welcome to the amazing world...<br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/></div>
				<br />
	        </div>
        </div>
      </div>
